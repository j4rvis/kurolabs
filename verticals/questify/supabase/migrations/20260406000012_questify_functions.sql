-- ============================================================
-- Questify Migration 3: Database Functions & Triggers
-- Note: complete_quest is upgraded in 20260413000001 once the
-- quest_giver_relationship_id column is added to quests.
-- ============================================================
...
-- -------------------------------------------------------
-- Complete a quest atomically (v1)
-- Called by the complete-quest Edge Function (service role)
-- Upgraded to v2 in 20260413000001 (adds giver relationship guard).
-- -------------------------------------------------------
